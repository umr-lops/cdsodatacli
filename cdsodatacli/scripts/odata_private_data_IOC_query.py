...
def main():
    ...
    parser.add_argument("-t", "--type", required=True, help="Product type (e.g. WV_SLC__1S_PRIVATE)")
    parser.add_argument("-d", "--date", required=True, help="Start date (e.g. 2025-01-01T00:00:00)")
    parser.add_argument("-o", "--output", required=True, help="Output JSON file path")
    parser.add_argument("-u", "--unit", required=True, help="Satellite Unit Identifier (C or D)")
    ...
    parser.add_argument("--limit", type=int, default=1000, help="Max records to return (default: 1000)")
    ...
    print(f"[*] Querying CDSE OData...")
    
    try:
        # Requests automatically handles URL encoding of spaces, quotes, and symbols
        search_res = requests.get(odata_url, params=params, headers=headers, verify=False)
