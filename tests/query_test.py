...
def create_test_gdf(start_datetime, end_datetime, geometry=None, collection=None, 
                    name=None, sensormode=None, producttype=None, attributes=None, 
                    id_query="test1"):
...
def test_queries(gdf_input, expected_products, id_query, mock_requests, patch_normalize_gdf):
    ...
    assert str(unique_ids[0]) == id_query, \
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                create_mock_product("1", "S2A_MSIL1C_20220503T000000_R001_T30TXL_20220503T000000"),
                create_mock_product("2", "S2B_MSIL1C_20220503T000000_R001_T30TXL_20220503T000000"),
            ],
            "test1",
        ),
    ],
)
def test_id_original_query(gdf_input, expected_products, id_query, mock_requests, patch_normalize_gdf):
...
def test_multiple_id_original_query(mock_requests, patch_normalize_gdf):
    ...
    assert counts["test1"] == counts["test2"], \
