from cdsodatacli.utils import convert_json_odata_query_to_listing_safe_4_download
import logging
import time
import argparse
...
def main():
    ...
    convert_json_odata_query_to_listing_safe_4_download(json_path=args.json)
